...
import MovieBanner from '../../Components/GameComponents/Other/MovieBanner';
...
function Games({ drawerIsOpen }) {
    const obj = ContextFunction();
    const { allGames, isGrid, setIsGrid } = obj;
    ...
    if (foundIndex >= 0) {
        let ready = allGames[foundIndex].FinishedData;
        defaultData = ready;
    }
        ...
        <div className={`${styles.Container} ${drawerIsOpen && !MediaBelow ? styles.drawerOpen : styles.normal} ${MediaBelow && !isGrid ? styles.fullWidth : styles.nothing}`}>
            ...
            <div className={styles.containerInput}>
                ...
                <div onClick={openModal} title='Select Directory' htmlFor="file-input" className={styles.fileText}>
                    ...
                    <div className={styles.text}>Add Games</div>
                </div>
